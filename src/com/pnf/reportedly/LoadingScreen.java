...
public class LoadingScreen extends AsyncTask<String, Integer, String>{
	...
	protected String doInBackground(String... value) {
		...
		if(rqst.equals("recent_report"))
		{
			...
			try {
				...
				{
					Home_Screen.btnLoadMore.setVisibility(View.GONE);
	...
	protected void onPostExecute(String result) {
		...
		if(rqst.equals("recent_report"))
		{
			...
			//loadmore.setVisibility(View.INVISIBLE);
			Home_Screen.btnLoadMore=new Button(activity);
			Home_Screen.btnLoadMore.setText("Load more");
			Home_Screen.list.addFooterView(Home_Screen.btnLoadMore);


	        
			Home_Screen.btnLoadMore.setOnClickListener(new View.OnClickListener() {
