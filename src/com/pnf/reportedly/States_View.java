...
import com.pnf.reportedly.Most_Stories_By.MostAdapter;
	...
	protected void onCreate(Bundle saveInstance) {
		...
		new AsyncTask<String, Integer, ArrayList<HashMap<String, String>>>() {
			...
			protected void onPreExecute() {
				...
				super.onPreExecute();
				progressdialog1 = new ProgressDialog(States_View.this);
			...
			protected ArrayList<HashMap<String, String>> doInBackground(
				...
				try {
					...
					{
						System.out.println("---Message falls--------");
					}
			...
			protected void onPostExecute(
				...
				adapter = new LazyAdatpter(States_View.this, stats_arraylist,"stats");
				...
				new AsyncTask<String, Integer, ArrayList<HashMap<String, String>>>() {
					...
					protected void onPostExecute(
						...
						stats_list.setAdapter(adapter);
							...
							Toast.makeText(States_View.this, "NO More Record Found",
		...
		protected Void doInBackground(Void... unused) {
			runOnUiThread(new Runnable() {
				public void run() {
                    ...
                    System.out.println("---texturl is new----- "+url + app_id +"/"+ current_page);
					...
					stats_list.setSelectionFromTop(current_page + 1, 0);
